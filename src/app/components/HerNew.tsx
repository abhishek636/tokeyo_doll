...
const HeroNew: React.FC = () => {
    return (
        <section className="relative flex flex-col items-center justify-center bg-[#111111] text-center  sm:py-20 py-8 h-screen max-w-screen overflow-hidden" >
            ...
            <Image src="/assets/images/ainew.png" alt="Animated GIF" className="z-10  lg:object-contain object-cover 2xl:-mt-40 lg:-mt-34 -mt-5 min-h-[300px] min-w-[532px]" width={1300} height={900} />
        </section>
    );
};
