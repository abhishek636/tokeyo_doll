...
const HeroNew: React.FC = () => {
    return (
        <section className="relative flex flex-col items-center justify-center bg-[#111111] text-center  sm:py-20 py-8 min-h-screen h-screen max-w-screen overflow-hidden" >
            ...
            />
            <h2 className="text-white z-20 mb-3 md:text-[40px] lg:text-[64px] text-[36px] sm:mt-40">Ready. Set.<br className="sm:hidden block px-4" /> Stream.</h2>
            ...
            <Image src="/assets/images/ainew.png" alt="Animated GIF" className="z-10  object-cover 2xl:-mt-50 lg:-mt-34 -mt-5 " width={1300} height={900} />
        </section>
    );
};
