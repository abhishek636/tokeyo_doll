...
import Link from 'next/link'; // Assuming you use next/link for internal navigation
 
export default function Footer() {
    return (
        <footer className="bg-black text-gray-300 py-12 md:py-24">
            <div className="max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 md:grid-cols-6 gap-8 md:gap-12 lg:gap-16">
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 col-span-1 md:col-span-1 lg:col-span-4 gap-8 md:gap-12 lg:gap-16">
