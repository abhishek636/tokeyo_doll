...
const modules = [
    {
        ...
        icon: (<img src="/assets/images/eng.png" alt="eng" width="100" height="60" />),
    },
    {
        id: 2,
        title: '西班牙语提示',
        subtitle: '简体中文提示',
        icon: (<img src="/assets/images/简体中文提示.png" alt="Consciousness Icon" width="100" height="60" />),
    },
    {
        id: 3,
        title: 'Española',
        subtitle: 'indicaciones en español',
        icon: (<img src="/assets/images/epanola.png" alt="Consciousness Icon" width="100" height="60" />),
    },
    {
        id: 4,
        title: 'Tiếng Việt',
        subtitle: 'Lời nhắc tiếng Việt',
        icon: (<img src="/assets/images/tie.png" alt="Tiếng Việt" width="100" height="60" />),
    },
    {
        id: 5,
        title: 'Русский',
        subtitle: 'Русские подсказки',
        icon: (<img src="/assets/images/pycc.png" alt="Consciousness Icon" width="100" height="60" />),
    },
];
        ...
        <div className='bg-[#000000] sm:pt-30 sm:pb-48 pt-16 pb-16 sm:min-h-screen'>
            <div className="w-full max-w-full md:max-w-6xl mx-auto text-white">
                ...
                <p className="text-center text-[#A0A0A0] mb-8 max-w-[761px] mx-auto sm:mb-22 ms:px-0 px-4">
                    English prompts, Simplified Chinese prompts. Traditional Chinese prompts, Vietnamese prompts, Spanish prompts, Russian prompts
                </p>
                {/* Mobile Slider */}
